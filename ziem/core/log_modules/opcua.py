...
class SubscriptionHandler:
    def __init__(self, ip, src, queue_alerts=None, queue_rep=None):
        self.ip = ip
        self.src_node, self.src_sub = src if type(src)!=str else (src, None)
    ...
    try:
        ...
        while True:
            async with client as c:
                handler = SubscriptionHandler(ip, (node, sub), queue_alerts, queue_rep)
