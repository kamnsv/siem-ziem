...
```
- Проверить применение настроек политики `auditpol /get /category:*`
...
- Необходимо скачать [файл](/static/bat/log_windows7.bat) и запустить с правами администратора  
