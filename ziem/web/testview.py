...
sys.path.append("..")
from ziem.core.log_modules.wmi import DCOM, IEnum
from ziem.core.log_modules.ftp import get_log
from ziem.core.log_modules.netmap import pinger
from ziem.core.log_modules.opcua import SubscriptionHandler, print_tree_node
    ...
    if ip:
        ...
        try:
            async with client as c:
                ...
                if log:
                    if not os.path.isdir(os.path.join(bp.static_folder, 'yaml')):
                        os.mkdir(os.path.join(bp.static_folder, 'yaml'))
